...
//                test.saveDataModel(testFile, overwrite);
    ...
    public static void recommend(int nFolds, String inPath, String outPath) {
        for (int i = 0; i < nFolds; i++) {
            ...
            int factors = 10;
            int interactions = 50;
            String factType = "org.apache.mahout.cf.taste.impl.recommender.svd.FunkSVDFactorizer";
            Recommender recommender = null;
            try {
				//            	recommender = grb.buildRecommender(trainModel, recommenderClass, similarityClass, neighborhoodSize);
                recommender = grb.buildRecommender(trainModel, recommenderClass,factType,interactions, factors);
